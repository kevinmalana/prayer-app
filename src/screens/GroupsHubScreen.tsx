  ...
  return (
    ...
    >
      <SectionCard
        ...
        title="12 members · 3 active prayer goals"
      ...
      <SectionCard
        ...
        support="Large-group prayer campaigns, feast-day prayer goals, and parish-wide reminders."
      />
      <SectionCard
        label="Youth Rosary"
        title="36 members · Friday night prayer"
        support="Smaller circles with lighter tone, faster invites, and repeat weekly prayer goals."
      />
    </ScreenShell>
  );
}
